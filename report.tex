...
Mahfuz & Entry CRUD views and EntryForm with validation, Category CRUD views, Budget CRUD views and BudgetForm, entry list filtering by type/category/tag/date, pagination, process\_recurring management command \\[4pt]
Abid   & ReportView with date-range logic, CSV export view, custom template tag library (currency filter, percentage filter, tag\_pills inclusion tag, category colour filter), Chart.js area chart and donut chart in the report template \\
\bottomrule
\end{tabular}
...
Mahfuz & Fixed budget admin syntax error, updated entry form with client-side category filtering, wired drawer system for category and budget forms \\[4pt]
Abid   & Fixed currency symbol in template tags and chart callbacks, fixed category colour hex filter, resolved template tag errors in report page \\
\bottomrule
\end{tabular}
...
\begin{itemize}
  ...
  \item \textbf{Mahfuz Iqram Sunny} --- All CRUD views and forms for entries, categories, and budgets
  \item \textbf{Abid Ahmed Angkon} --- Reports, CSV export, custom template tags, Chart.js visualisations
\end{itemize}
...
Mahfuz Iqram Sunny & 2023200010034 & Person 2 \\
Abid Ahmed Angkon  & 2023200010039 & Person 3 \\
\hline
\end{tabular}
\end{table}
...
\section{Mahfuz Iqram Sunny --- Person 2}
...
\section{Abid Ahmed Angkon --- Person 3}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{ss_dashboard.jpeg}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{ss_entries.jpeg}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{ss_categories.jpeg}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{ss_budgets.jpeg}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{ss_reports.jpeg}
